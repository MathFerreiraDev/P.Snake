        ...
        if(len(funcionarios)==0):
          ...
          while(logado==True):
            ...
            #Caso deseje consultar a lista de clientes registrados
             if(escolha==1):
                ...
                while(loop==True):
                    ...
                    print("3 - Retornar")
                    print("----------------")
                    escolha = int(input("Tecle: "))
                    escolha = VerificNumber(escolha,3)
                    #Caso queira adicionar um novo cliente
                    if(escolha==1):
                     Registro_Cliente()
                    #Cao queira remover um cliente da listagem
                    elif(escolha==2):
                        if(len(clientes)==0):
            ...
            #Caso deseje realizar a venda de algum produto
               ...
               if(len(clientes)>0):
                print("| 2 - Inserir ID de cliente            |")
                print("| 3 - Adicionar cliente para compra    |")
                print("| 4 - Retonar                             |")
               else:
                print("| 2 - Retornar                             |")
               ...
               if(len(clientes)>0):
                escolha = VerificNumber(escolha,4)
               else:
                 escolha = VerificNumber(escolha,2)
               ...
               if(len(clientes)>0):
                ...
                if(len(produtos)==0):
                  VerificNumber(escolha,1)
                else:
                  VerificNumber(escolha,2)  
                  if(escolha==1):
                    adendo = True
                    lista = []
                    soma = 0
